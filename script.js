...
//it  will shows full meal details in main section 
        ...
        html += `
          <div id="meal-details" class="mb-5">
            ...
            <div class="text-center">
              <a href="${data.meals[0].strYoutube}" target="_blank" class="btn btn-outline-dark mt-3">Watch on youtube</a>
            </div>
          </div>
        `;
    });
...
// it will shows all favourites meals in favourites body
